      ...
      <div className="p-4 sm:p-6 md:p-10 max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-6 md:pb-7 border-b border-gray-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 tracking-tight">Biblioteca Digital</h1>
              <p className="text-xs sm:text-sm text-gray-500 mt-0.5">Acervo de apoio para os módulos oficiais da Escola Discover</p>
            </div>
          </div>
          <button
            onClick={openModal}
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="flex items-center justify-center lg:justify-start gap-1 bg-white border border-gray-200 rounded-xl p-1 h-11 shrink-0 w-full lg:w-auto">
            <button
              type="button"
              onClick={() => setViewMode('grid')}
              title="Visualização em grade"
              className={`h-full flex-1 lg:flex-none lg:aspect-square flex items-center justify-center rounded-lg transition-colors ${
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <button
                        ...
                        className="text-gray-300 hover:text-red-500 hover:bg-red-50 p-1.5 rounded-lg transition-colors md:opacity-0 group-hover:opacity-100"
                        title="Excluir"
                      >
                ...
                {materiaisFiltrados.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-400 shrink-0 w-28 truncate">
                        {config.label}
                      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex justify-center items-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSaveMaterial} className="p-4 sm:p-6 space-y-4 sm:space-y-5">
              <div>
