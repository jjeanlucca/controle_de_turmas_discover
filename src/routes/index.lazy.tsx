  ...
  return (
    <div className="min-h-screen bg-gray-50/60">
      <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-[#2c1f5c] via-[#3d2a80] to-[#241a4d] rounded-3xl p-8 md:p-10 text-white shadow-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-2xl border border-gray-200 flex items-center justify-between hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 flex items-center justify-between hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div className="space-y-1">
              <p className="text-sm text-gray-500">Aulas na biblioteca</p>
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 flex items-center justify-between hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div className="space-y-1">
              <p className="text-sm text-gray-500">Atividades cadastradas</p>
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link
              to={"/turmas" as never}
              className="group bg-white p-6 rounded-2xl border border-gray-200 hover:border-[#6c47e6]/40 hover:shadow-md transition-all duration-200 flex flex-col justify-between space-y-6"
            >
            ...
            <Link
              to={"/alunos" as never}
              className="group bg-white p-6 rounded-2xl border border-gray-200 hover:border-blue-400 hover:shadow-md transition-all duration-200 flex flex-col justify-between space-y-6"
            >
              <div className="space-y-3">
            ...
            <Link
              ...
              className="group bg-white p-6 rounded-2xl border border-gray-200 hover:border-indigo-400 hover:shadow-md transition-all duration-200 flex flex-col justify-between space-y-6"
            >
              <div className="space-y-3">
